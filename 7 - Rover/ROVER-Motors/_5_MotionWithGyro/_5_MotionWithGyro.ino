...
void rotateGauche(int speed=100, int degree=45,int degreeMove = 0 ){
	...
	while(angle<(angleInit-degreeMove)){
		//TURN ON MOTORS-------------------------------------------------
		getAngles();
		delay(10);
	}
...
// Fonction to have the ROVER rotating *********************************************************************************
void rotateGaucheTime(int speed=100,int time=10000, int degree=45){
...
// Fonction to have the HOVER rotating*********************************************************************************
void rotateDroitTime(int speed=100,int time=10000, int degree=45){
...
void loop(){
  ...
  if(angleReceived>0){
  //right
    rotateGauche(100,45,angleReceived);
  }else{
  //left
    rotateDroit(100,45,angleReceived);
  }
