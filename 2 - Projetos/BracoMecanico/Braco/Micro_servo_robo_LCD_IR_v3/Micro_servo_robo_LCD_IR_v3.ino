...
#define IR_IN  2  //Infrared receiver Pin
...
LiquidCrystal lcd(8, 9, 4, 5, 6, 7);   // set the LCD address to 0x27 for a 20 chars and 4 line display
...
void setup()
{
  ...
  myservo1.attach(13);  // attaches the servo 1 on pin 4 to the servo object 
  myservo2.attach(12);  // attaches the servo 2 on pin 5 to the servo object 
  myservo3.attach(11);  // attaches the servo 3 on pin 6 to the servo object 
  myservo4.attach(10);  // attaches the servo 4 on pin 7 to the servo object
  myservo5.attach(3);  // attaches the servo 5 on pin 8 to the servo object 
