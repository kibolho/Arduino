...
void loop() {
  Serial.print("Entregar: ");
  for(int x=0;x<4;x++){
    Serial.print(andaresParaEntregar1[x]);
    Serial.print(" ");
  }
  Serial.print("Atender: ");
  for(x=0;x<6;x++){
   Serial.print(andaresParaAtender[x]);
   Serial.print(" ");
  }
   Serial.print("Indo Atender:");
   Serial.print(andarIndoAtender);
     Serial.print(" ");
     Serial.print("Andar Atual:");
   Serial.print(andarAtualElevador1);
     Serial.println();
...
/*  
  ...
  Serial.println(andarAtualElevador1,DEC);
  */
  ...
  switch(thisSwitch){  
    ...
    case 1: 
      ...
      else if( (andaresParaAtender[2]==1) && andarIndoAtender>1){
        para1(22);
      }
      //PRECISA PEGAR ALGUEM NESSE ANDAR e A PESSOA VAI DESCER E NÃO TEM NINGUEM PEDINDO PRA SUBIR
      else if( (andaresParaAtender[1]==1) && andarIndoAtender<3){
        para1(21);
      }
    break;
    ...
    displayElevador1(3);
      ...
      //PRECISA PEGAR ALGUEM NESSE ANDAR e A PESSOA VAI SUBIR E NÃO TEM NINGUEM PEDINDO PRA DESCER
      else if( (andaresParaAtender[4]==1) && andarIndoAtender>2){
        para1(32);
      }
      //PRECISA PEGAR ALGUEM NESSE ANDAR e A PESSOA VAI DESCER E NÃO TEM NINGUEM PEDINDO PRA SUBIR
      else if( (andaresParaAtender[3]==1) && andarIndoAtender<4){
        para1(31);
      }
    break;
