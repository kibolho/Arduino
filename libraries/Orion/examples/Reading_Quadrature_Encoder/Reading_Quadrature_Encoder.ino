...
void loop() { 
  ...
  if(valid){
    terminal.print(“Encoder1:”); terminal.print(enc1,HEX); terminal.print(“ “); terminal.print(status,HEX);
  }
  terminal.print(“ “);
  uint32_t enc2 = roboclaw.ReadEncM2(address, &status, &valid); 
  if(valid){
    terminal.print(“Encoder2:”); terminal.print(enc2,HEX); terminal.print(“ “); terminal.print(status,HEX);
  } 
  terminal.print(“ “);
